...
class CodeTest extends TestCase
{
    ...
    {
        $userModel = LaravelProgrammingStyle::for('Tests\\App\\User')->toFile();

        $this->assertSame(file_get_contents(__DIR__.'/../../App/User.php'), $userModel);
    }

    public function testWeCanUseTraitsAndImplementAContract()
    {
        $newUserModel = LaravelProgrammingStyle::for('Tests\\App\\User')
